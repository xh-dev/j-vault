...
class HandlerFactorTest {
    ...
    void testProtocolAbc() {
        ...
        assertEquals(200, testResult.statusCode(), "expected status code");
        ...
        assertEquals(expectedResult, testResult.body(), "expecting return the base 64 encoded public key");
        server.stop(1);
    }
